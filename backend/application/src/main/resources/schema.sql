...
INSERT INTO question(question_id, question_num, question_description, question_type) VALUES (1,1,'어떤 음식을 좋아하시나요?', 'c');
INSERT INTO question_choice(question_choice_id, question_id, question_choice_number, question_choice_description) VALUES (1, 1, 1, '한식'), (2, 1, 2, '중식'), (3, 1, 3, '일식'), (4, 1, 4, '양식'), (5, 1, 5, '분식');

INSERT INTO question(question_id, question_num, question_description, question_type) VALUES (2,2,'어떤 음악 장르를 좋아하나요?' ,'c');
INSERT INTO question_choice(question_choice_id, question_id, question_choice_number, question_choice_description) VALUES (6, 2, 1, '케이팝'), (7,2,2,'팝송'),(8,2,3,'락'),(9,2,4,'발라드'),(10,2,5,'R&B');

INSERT INTO question(question_id, question_num, question_description, question_type) VALUES (3, 3, '취미가 무엇인가요?','c');
INSERT INTO question_choice(question_choice_id, question_id, question_choice_number, question_choice_description) VALUES (11,3,1,'운동'), (12,3,2,'영화'), (13, 3, 3, '독서'), (14, 3, 4, '공연'), (15, 3, 5, '그림'), (16, 3, 6, '음악'), (17, 3, 7, '게임');

-- 네 번째 질문
INSERT INTO question(question_id, question_num, question_description, question_type) VALUES (4, 4, '자주 사용하는 앱이나 웹사이트가 있나요?', 'c');
INSERT INTO question_choice(question_choice_id, question_id, question_choice_number, question_choice_description) VALUES
                                                                                                                      (18, 4, 1, '유튜브'),
                                                                                                                      (19, 4, 2, 'SNS'),
                                                                                                                      (20, 4, 3, '게임'),
                                                                                                                      (21, 4, 4, '인터넷 사이트'),
...
-- 다섯 번째 질문
INSERT INTO question(question_id, question_num, question_description, question_type) VALUES (5, 5, '최근에 시작한 활동이 있나요?', 'c');
INSERT INTO question_choice(question_choice_id, question_id, question_choice_number, question_choice_description) VALUES
                                                                                                                      (24, 5, 1, '일찍 일어나기'),
                                                                                                                      (25, 5, 2, '새로운 공부'),
                                                                                                                      (26, 5, 3, '꾸준한 운동'),
...
-- 여섯 번째 질문
INSERT INTO question(question_id, question_num, question_description, question_type) VALUES (6, 6, '여행을 갈 때 주로 어떤 타입에 해당이 되시나요?', 'c');
INSERT INTO question_choice(question_choice_id, question_id, question_choice_number, question_choice_description) VALUES
                                                                                                                      (30, 6, 1, '경치 좋은 곳 위주로 나들이를 즐긴다'),
                                                                                                                      (31, 6, 2, '볼거리와 재미를 주로 추구한다'),
                                                                                                                      (32, 6, 3, '문화 체험을 지향한다'),
                                                                                                                      (33, 6, 4, '음식이나 쇼핑 등을 선호한다'),
                                                                                                                      (34, 6, 5, '여행을 가지 않는다');

INSERT INTO question(question_id, question_num, question_description, question_type) VALUES (7, 7, '주로 방문하는 장소는 어디인가요? (도서관, 카페 등)', 's');
