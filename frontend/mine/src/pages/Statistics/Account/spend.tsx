...
import { containerCss, itemsCss, spendCss, itembarCss, itemlabelCss, itempriceCss, allbtnCss } from './spend.style';
...
const SpendChart: React.FC<SpendChartProps> = ({ period, offset }) => {
  ...
  const displayData = showAll || filteredData.length <= 5 
    ? filteredData 
    : [...topCategories, { id: 'other', name: '그 외 카테고리', money: otherTotal, color: '#cccccc' }];
